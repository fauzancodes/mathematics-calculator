...
function filter(input) {
    var filter_parameter = "." + $(input).text().toLowerCase();
    ...
    $(input).parent().siblings().fadeOut("fast");
    $(input).parent().siblings(filter_parameter).fadeIn("fast");
}
//-------------------------
...
$("#root-2").click(function() {
    var text = Math.sqrt((eval_monitor()), 2);
    result_monitor(text);
});
$("#root-3").click(function() {
    var text = Math.sqrt((eval_monitor()), 3);
    result_monitor(text);
});
$("#root").click(function() {
